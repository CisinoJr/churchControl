...
describe('Service Tests', () => {
    ...
    describe('MembrosChurch Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MembrosChurchService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/membros';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MembrosChurch', () => {

                let entity: MembrosChurch;
                service.find(123).subscribe((_entity: MembrosChurch) => {
                    entity = _entity;
                });
