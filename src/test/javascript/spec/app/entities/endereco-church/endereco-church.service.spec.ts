...
describe('Service Tests', () => {
    ...
    describe('EnderecoChurch Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EnderecoChurchService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/enderecos';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EnderecoChurch', () => {

                let entity: EnderecoChurch;
                service.find(123).subscribe((_entity: EnderecoChurch) => {
                    entity = _entity;
                });
